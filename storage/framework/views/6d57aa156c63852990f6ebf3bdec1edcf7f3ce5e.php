                ...
                <!-- Modal Body -->
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">     <?php echo $__env->make('partials.bs_text', ['name' => 'additional_no', 'label' => 'Additional Contact', 'extras' => 'required="required"', 'useOld' => ''], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">  <?php echo $__env->make('partials.selectpicker', ['name' => 'role', 'label' => 'User Type', 'options' =>['Admin', 'Employee', 'Salesman', 'Super','Supplier'], 'useKeys' => 'true', 'extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
                        </div>
