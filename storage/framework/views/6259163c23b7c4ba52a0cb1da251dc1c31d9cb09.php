    ...
    <form action="<?php echo e(route('tickets.store')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <?php echo $__env->make('partials.bs_date', ['name' => 'request_date', 'label' => 'Request Date', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php echo $__env->make('partials.bs_textarea', ['name' => 'work_dscription', 'label' => 'Work Dscription', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-fill btn-danger">Create Ticket</button>
