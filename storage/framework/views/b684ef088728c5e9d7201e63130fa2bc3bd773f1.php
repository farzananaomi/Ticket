        ...
        <td align="center">
            <table width="100%">
                <tr >
                    ...
                    <td></td>
                    <td></td>
                    <td><?php echo e(date('h-i-s A')); ?></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td> Invoice No# <?php echo e($invoice->id); ?></td>
    </tr>
    <tr>
        <td>Customer ID: <?php echo e($invoice->customer->id); ?></td>
        <td>Customer Name: <?php echo e($invoice->customer->customer_name); ?></td>
        <td>Salesman: <?php echo e(Auth::user()->name); ?></td>
    </tr>
</table>
...
<table class="table table-bordered table-striped">
    ...
    <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td class="table-total text-right"><?php echo e($item->quantity * $item->unit_price); ?></td>
        </tr>
    ...
    <tr>
        ...
        <td class="table-amount"><?php echo e($invoice->vat_total); ?> Tk</td>
    </tr>
    <tr>
        <td class="table-empty" colspan="2" style="border:0"></td>
    ...
    <tr>
        ...
        <td class="table-amount"><?php echo e($invoice->payment_type); ?> </td>
    </tr>
    </tfoot>
</table>
</body>
