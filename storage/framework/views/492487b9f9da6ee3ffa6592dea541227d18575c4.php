                        ...
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'product_name', 'label' => 'Product Name', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php echo $__env->make('partials.bs_textarea', ['name' => 'description', 'label' => 'Product Description', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'size', 'label' => 'Size', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
