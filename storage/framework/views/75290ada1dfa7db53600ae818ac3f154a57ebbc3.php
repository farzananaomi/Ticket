                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-xs-4">
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'customer_name', 'label' => 'Full Name', 'useOld' => '', 'horizontal' => 'false','extras' => 'required="required"'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>

                                <div class="col-xs-4">
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'mobile_no', 'label' => 'Contact', 'useOld' => '', 'horizontal' => 'false'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <div class="col-xs-4">
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'address', 'label' => 'Address', 'useOld' => '', 'horizontal' => 'false'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-xs-6">
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'barcode_id', 'label' => 'Barcode', 'useOld' => '', 'horizontal' => 'false'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <div class="col-xs-4">
                    ...
                    <div class="content">
                        <div class="form-horizontal">
                            <div class="row">
                                    ...
                                    <div class="card-content table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-label"><input type="text" class="form-control"
                                                                               value="0" id="sub_total"
                                                                               name="sub_total" readonly/></td>
                                                <td class="table-amount"><input type="text" class="form-control"
                                                                                value="0" id="vat_total"
                                                                                name="vat_total" readonly/></td>
                                                <td class="table-amount"><input type="text" class="form-control"
                                                                                value="0" id="total_amount"
                                ...
                                <div class="col-xs-4">
                                    <?php echo $__env->make('partials.bs_date', ['name' => 'invoice_date',  'label' => 'Invoice Date', 'useOld' => date('Y-m-d'),'horizontal' => 'false', 'extras' => 'data-bind="text: dob"',], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <div class="col-xs-4">
                                    <?php echo $__env->make('partials.selectpicker', ['name' => 'payment_type',  'label' => 'Payment Type',  'options' =>['Cash', 'Card', 'Both'], 'horizontal' => 'false','useKeys' => false,'useOld' => '',], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                                </div>


                                <div class="col-xs-2">
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'card_type', 'useOld' => '','placeholder'=>'Card Details'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <div class="col-xs-2">
                                    <?php echo $__env->make('partials.bs_text', ['name' => 'bank_amount',   'useOld' => '','placeholder'=>'Card amount'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).on('change', '#barcode_id', function () {
    ...
    function addExp() {
        ...
        if (barcode_id.length > 5) {
            $.ajax({
                url: "<?php echo e(route('ajax.get_product_details')); ?>",
                data: {id: barcode_id},
                type: "get",
