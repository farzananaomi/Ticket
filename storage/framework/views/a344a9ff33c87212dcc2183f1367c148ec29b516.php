                        ...
                        <!--   if you want to have the card without animation please remove the ".card-hidden" class   -->
                            <div class="card card-hidden">
                                <div class="header text-center" style="padding-bottom: 5px;">
                                    <img src="<?php echo e(asset('img/blog.png')); ?>" alt="Harmony - Easy EHS" style="height: 40px;margin-right: 10px;">
                                ...
                                <div class="footer text-left">
                                    ...
                                    <a href="<?php echo e(route('registration.create')); ?>"
                                       class="btn btn-fill btn-warning pull-right"><i class="fa fa-arrow-left"></i> Registration</a>
                                </div>
        ...
        <footer class="footer footer-transparent">
            <div class="container">
                ...
                <p class="copyright pull-right">
                    <a href="http://www.singularitybd.com">
                        <img class="singularity-credit-logo" src="<?php echo e(asset('img/singularity-credit-white.png')); ?>"
