            ...
            <div class="card">
                ...
                <div class="content">
                    <div class="form-horizontal">
                        <div class="row">
                            <div class="col-xs-12">
                                <?php echo $__env->make('partials.bs_static', ['label' => 'Name', 'value' => $designation->name], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo $__env->make('partials.bs_static', ['label' => 'Voter No', 'value' => $designation->description], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
