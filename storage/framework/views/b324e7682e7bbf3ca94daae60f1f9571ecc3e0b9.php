...
<div class="wrapper">
    <div class="sidebar" data-color="red" data-image=<?php echo e(asset('theme/img/background.jpg')); ?>>
        

        <div class="logo">
            <a href="#" class="logo-text">
                <img src="<?php echo e(asset('img/blog.png')); ?>" alt="Blog" style="height: 40px;margin-right: 10px;">
                <span>
                   Invoice
                </span>
            </a>
        ...
        <div class="logo logo-mini">
            <a href="<?php echo e(url('')); ?>" class="logo-text">
                <img src="<?php echo e(asset('img/blog.png')); ?>" alt="Blog" style="height: 28px;">
            </a>
        </div>
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="<?php echo e(is_active('category*')); ?>">
                    <a href="<?php echo e(route('categories.index')); ?>">
                        <i class="fa fa-address-book-o"></i>
                        <p> All Category</p>
                    </a></li>
                <li class="<?php echo e(is_active('categories*')); ?>">
                ...
                <li class="<?php echo e(is_active('entities*')); ?>">
                    <a href="<?php echo e(route('invoices.create')); ?>">
                        <i class="fa fa-id-badge"></i>
                        <p> Create Invoice</p>
                    </a></li>
                <li class="<?php echo e(is_active('members*')); ?>">
                    <a href="<?php echo e(route('invoices.index')); ?>">
                        <i class=" fa fa-user-plus"></i>
                        <p>Invoice List</p>
                    </a></li>
                <li class="<?php echo e(is_active('candidate*')); ?>">
                    <a href="<?php echo e(route('stocks.create')); ?>">
                        <i class=" fa fa-address-card"></i>
                        <p> Storage</p>
                    </a></li>
                <li class="<?php echo e(is_active('edit_requests*')); ?>">
                ...
                <li class="<?php echo e(is_active('edit_requests*')); ?>">
                    <a href="<?php echo e(route('barcodes.printbarcode')); ?>">
                        <i class="fa fa-pencil"></i>
                        <p> Print Barcode</p>
                    </a></li>
            </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <img class="batb-logo" src="<?php echo e(asset('img/blog.png')); ?>"
                                 alt="Blog Story">
                        </li>
