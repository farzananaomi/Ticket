                        ...
                        <div class="form-horizontal">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    @include('partials.bs_date', ['name' => 'request_date', 'label' => 'Request Date', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'])
                                    @include('partials.bs_textarea', ['name' => 'work_dscription', 'label' => 'Work Dscription', 'useOld' => '', 'horizontal' => 'true', 'extras' => 'required="required"'])
                                </div>
                            </div>
                        </div>
                    </div>
