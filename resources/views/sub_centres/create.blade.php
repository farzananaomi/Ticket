...
@section('content')
    <form action="{{ route('sub_centres.store') }}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">Create Sub Centres</div>
                    <div class="content">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-fill btn-danger">Create Sub Centres</button>
